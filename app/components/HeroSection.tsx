...
export default function HeroSection() {
  return (
    <section className="w-full pt-[20px] flex min-h-screen items-center">
      <div className="mx-auto grid w-full max-w-[1500px] grid-cols-1 gap-20 px-8 md:px-14 lg:grid-cols-2 lg:px-20">
        ...
        >
          <div className="mb-6 flex w-fit items-center gap-2 rounded-full border border-[#FF9D5C]/20 bg-[#FF9D5C]/10 px-4 py-2 text-sm text-[#FFB27D]">
            <Sparkles size={14} />

            Trusted by 10,000+ developers
          </div>

          <h1 className="max-w-[700px] text-[40px] font-bold leading-[1.1] tracking-[-0.03em] md:text-[56px] ">
          ...
          <p className="mt-6 max-w-[620px] text-lg leading-relaxed text-white/60">
         ...
         <div className="mt-5 flex flex-wrap gap-5">
            <button className="flex items-center gap-2 rounded-lg bg-[#FF9D5C] px-7 py-4 text-base font-semibold text-black shadow-[0_10px_30px_rgba(255,157,92,0.35)] transition-all duration-300 hover:scale-105">
              Start Free
              <ArrowRight size={18} />
            </button>

            <button className="flex items-center gap-2  border-white/10 rounded-lg bg-white/[0.04] px-8 py-4 text-base backdrop-blur-xl transition-all duration-300 hover:bg-white/[0.08]">
              <Play size={16} />
        ...
        <div className="relative flex items-center justify-center lg:justify-end">
         ...
         <div className="-translate-25 translate-x-5 h-[650px] w-full max-w-[720px]">
            <ModelViewer />
          </div>
